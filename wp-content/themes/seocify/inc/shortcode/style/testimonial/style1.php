<div class="testimonial-slider-preview owl-carousel" id="sync1-slider-preview-<?php echo $this->get_id(); ?>" data-id="sync1-slider-preview-<?php echo $this->get_id(); ?>">
...
<div class="testimonial-slider-thumb owl-carousel" id="sync2-slider-thumb-<?php echo $this->get_id(); ?>" data-id="sync2-slider-thumb-<?php echo $this->get_id(); ?>">
