...
class XS_Price_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        /* Pricing Table Month */
        $repeater_monthly = new Repeater();

		$repeater_monthly->add_control(
			'xs_featured_table', [
                'type' => Controls_Manager::SWITCHER,
		...
		$repeater_monthly->add_control(
			'table_title', [
                ...
                'default'   =>  esc_html__('Starter Plan','seocify'),
                'label_block' => true,
			]
		);
		...
		$this->add_control(
			'monthly_table_name',
			[
				'label' => __( 'Pricing Lists', 'seocify' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_monthly->get_controls(),
				'default' => [
					[
						'table_title' => __( 'Starter Plan', 'seocify' ),
						'currency_icon' => __( '$', 'seocify' ),
						'table_price' => __( '29.99', 'seocify' ),
						'table_duration' => __( 'Month', 'seocify' ),
                        'button_text' => __( 'Buy Now', 'seocify' ),
                        'button_url' => __( '#', 'seocify' ),
					],
					[
						'table_title' => __( 'Basic Plan', 'seocify' ),
						'currency_icon' => __( '$', 'seocify' ),
						'table_price' => __( '69.99', 'seocify' ),
						'table_duration' => __( 'Month', 'seocify' ),
                        'button_text' => __( 'Buy Now', 'seocify' ),
                        'button_url' => __( '#', 'seocify' ),
					],
					[
						'table_title' => __( 'Business Plan', 'seocify' ),
						'currency_icon' => __( '$', 'seocify' ),
						'table_price' => __( '499.99', 'seocify' ),
						'table_duration' => __( 'Month', 'seocify' ),
                        'button_text' => __( 'Buy Now', 'seocify' ),
                        'button_url' => __( '#', 'seocify' ),
					],
        ...
        $repeater_yearly = new Repeater();

		$repeater_yearly->add_control(
			'xs_featured_table', [
                'type' => Controls_Manager::SWITCHER,
                'label' => esc_html__('Do you want to feature it?', 'seocify'),
                'label_block'       => true,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Pricing Lists', 'seocify' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_yearly->get_controls(),
				'default' => [
					[
						'table_title' => __( 'Basic Plan', 'seocify' ),
						'currency_icon' => __( '$', 'seocify' ),
						'table_price' => __( '50.99', 'seocify' ),
						'table_duration' => __( 'Year', 'seocify' ),
                        'button_text' => __( 'Buy Now', 'seocify' ),
                        'button_url' => __( '#', 'seocify' ),
					],
					[
						'table_title' => __( 'Advanced Plan', 'seocify' ),
						'currency_icon' => __( '$', 'seocify' ),
						'table_price' => __( '100.99', 'seocify' ),
						'table_duration' => __( 'Year', 'seocify' ),
                        'button_text' => __( 'Buy Now', 'seocify' ),
                        'button_url' => __( '#', 'seocify' ),
					],
