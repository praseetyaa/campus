...
$fields[]= array(
    'type'        => 'color',
    'settings'    => 'cta_shadow_color',
    'label'       => __( 'Cta Button Shadow Color', 'kirki' ),
    'section'     => 'nav_section',
    'default'     => 'rgba(83, 109, 253, 0.25)',
    'choices'     => [
        'alpha' => true,
    ],
    'output'      => array(
        array(
            'element' 	=> '.header-style3.xs-header.header-main .nav-btn a.btn',
        ...
        array(
            'element' 	=> '.xs-seocify-header4 .xs-menu-tools .btn',
            'property'	=> '--box-shadow-color',
        ),
    ),
);
...
$fields[] = array(
    ...
    'output'      => array(
        ...
        array(
            'element' 	=> '.xs-header.header-main .xs-menu-tools>li>a',
            'property'	=> 'color',
        ),
        // array(
...
$fields[] = array(
    ...
    'output'      => array(
        ...
        array(
            'element' 	=> '.xs-header.header-style3 .xs-menus .nav-menu>li.active > a',
            'property'	=> 'color',
        ),
        array(
            'element' 	=> '.xs-header.header-main .xs-menus .nav-menu li.active a',
            'property'	=> 'color',
        ),
    ),
);
...
$fields[] = array(
    ...
    'output'      => array(
        ...
        array(
            'element' 	=> '.xs-header.header-style3 .xs-menus .nav-menu>li:hover > a',
            'property'	=> 'color',
        ),
    ),
);
...
$fields[]= array(
    'type'        => 'switch',
    'settings'    => 'nav_tools_show_mobile',
    'label'       => esc_html__( 'Show tools on mobile', 'seocify' ),
    'section'     => 'nav_section',
    'default'     => false,
    'choices'     => array(
        'on'  => esc_attr__( 'Enable', 'seocify' ),
